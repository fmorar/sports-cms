...
import casinoVivo from '../img/casino-vivo.jpg'
import pronosticosVivo from '../img/pronosticos-vivo.jpg'
import racebook from '../img/racebook.jpg'
						...
						<div className="columns">
							<div className="column is-9">
								<div className="column is-12">
									<div id="racebook" className="card">
								...
								<div className="column is-12">
									<div id="casinoVirtual" className="card">
									  <div className="card-content">
									    <div className="content">
										    <div className="columns">
													<div className="column is-3">
								...
								<div className="column is-12">
									<div id="casinoVivo" className="card">
									  <div className="card-content">
									    <div className="content">
										    <div className="columns">
													<div className="column is-3">
								...
								<div className="column is-12">
									<div id="pronosticosVivo" className="card">
									  <div className="card-content">
									    <div className="content">
										    <div className="columns">
													<div className="column is-3">
