    ...
    return (
		<div className="bonuses-page">
			<div className="bonuses--hero section-title">
				<h2 className="title title__main is-size-3 has-text-weight-bold is-bold-light text-center">Bonus Reload</h2>
			</div>
				...
				<div className="container">
					<nav className="breadcrumb" aria-label="breadcrumbs">
					  <ul>
					    ...
					    <li className="is-active"><a href="#" aria-current="page"> bonus reload </a></li>
					  </ul>
					</nav>
								...
								<div className="card">
								  <div className="card-content">
								    <div className="columns">
							  			<p className="column is-marginless">50% Bono de recarga</p>
							...
							<div className="column is-12">
								<div className="card">
								  <div className="card-content">
								    <div className="content">
									    <div className="columns">
								  			<p className="column is-marginless">30% Bono de recarga</p>
								  			<p className="column is-marginless is-1 is-hidden-mobile">|</p>
							...
							<div className="column is-12">
								<div className="card">
								  <div className="card-content">
								    <div className="content">
									    <div className="columns">
								  			<p className="column is-marginless">20% Bono de recarga</p>
								  			<p className="column is-marginless is-1 is-hidden-mobile">|</p>
							...
							<div className="column is-12">
								<div className="card">
								  <div className="card-content">
								    <div className="content">
									    <div className="columns">
								  			<p className="column is-marginless">10% Bono de recarga</p>
								  			<p className="column is-marginless is-1 is-hidden-mobile">|</p>
								...
								<div className="card">
								  <div className="card-content">
								    <div className="content">
							    		...
							    		<p>
							    			Aplica únicamente para los depósitos regulares.
										</p>
										<p>
